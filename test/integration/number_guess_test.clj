...
(deftest number-guess-with-permutations-test
  (testing
   "should call functions as many times as expected when doing permutations"
   (bond/with-spy
...
(deftest number-guess-with-mutations-test
  (testing
   "should call functions as many times as expected when doing mutations"
   (bond/with-spy
    [utils/score-objective-fn
     setters/set-scores
     setters/set-best-tree]
...
(deftest number-guess-with-crossover-test
  (testing
   "should call functions as many times as expected when doing crossover"
   (bond/with-spy
    [setters/set-best-tree
     setters/set-scores
     utils/score-objective-fn]
